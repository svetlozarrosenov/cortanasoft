...
const urls = {
    register: `${import.meta.env.VITE_BACK_END_URL}/user/register`,
    currentUser: `${import.meta.env.VITE_BACK_END_URL}/user/current`,
    login: `${import.meta.env.VITE_BACK_END_URL}/auth/login`,
    logout: `${import.meta.env.VITE_BACK_END_URL}/auth/logout`,
};
