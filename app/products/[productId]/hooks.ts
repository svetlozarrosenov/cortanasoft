...
export const urls = {
  fetchProduct: (id: string) => `${process.env.NEXT_PUBLIC_BACK_END_URL}/products/product/${id}`,
    fetchAllProducts: `${process.env.NEXT_PUBLIC_BACK_END_URL}/products/list`,
    createProduct: `${process.env.NEXT_PUBLIC_BACK_END_URL}/products/create`,
};
