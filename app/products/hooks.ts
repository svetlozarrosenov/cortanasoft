...
export const urls = {
  fetchProduct: (id: string) => `${process.env.REACT_APP_BACK_END_URL}/products/product/${id}`,
    fetchAllProducts: `${process.env.REACT_APP_BACK_END_URL}/products/list`,
    createProduct: `${process.env.REACT_APP_BACK_END_URL}/products/create`,
};
