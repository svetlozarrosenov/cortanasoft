...
export const urls = {
    fetchDevices: `${process.env.NEXT_PUBLIC_BACK_END_URL}/devices/admin/list`,
    installDevice: (id: string) => `${process.env.NEXT_PUBLIC_BACK_END_URL}/devices/install/${id}`,
    fetchClients: `${process.env.NEXT_PUBLIC_BACK_END_URL}/clients/list`,
    generateQRToeknResell: () => `${process.env.NEXT_PUBLIC_BACK_END_URL}/devices/qr/token/resell`,
    createDevice: `${process.env.NEXT_PUBLIC_BACK_END_URL}/devices/admin/create`,
};
